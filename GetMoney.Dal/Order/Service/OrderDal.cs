...
namespace GetMoney.Dal
{
    public class OrderDal : IOrderDal
    {
        ...
        public DataTable OrderLists(string No) {
            string sql = "select a.ID,a.OrderNo,convert(varchar(20),a.MeetDate,120) MeetDate,a.Userid,b.TrueName,a.AccrualMoney,a.State from Order_Lists a left outer join TUsers b on a.Userid=b.id where a.OrderNo=@No";
            SqlParameter[] parameter = new[]
            {
